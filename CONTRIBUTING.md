...
issue](https://github.com/cisagov/disable-inactive-iam-users-tf-module/issues) in this
...
request](https://github.com/cisagov/disable-inactive-iam-users-tf-module/pulls), you
...
```console
cd disable-inactive-iam-users-tf-module
pyenv virtualenv <python_version_to_use> disable-inactive-iam-users-tf-module
pyenv local disable-inactive-iam-users-tf-module
